            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active ">
                        <img src="https://www.w3schools.com/css/trolltunga.jpg" alt="Los Angeles"
                             style="width: 2000px;    height: 500px;">
                    </div>

                    <div class="item ">
                        <img src="https://www.w3schools.com/css/img_lights.jpg" alt="Chicago"
                             style="width: 2000px;    height: 500px;">
                    </div>

                    <div class="item">
                        <img src="https://www.smashingmagazine.com/wp-content/uploads/2015/06/10-dithering-opt.jpg"
                             alt="New York" style="width: 2000px;    height: 500px;">
                    </div>
                </div>
                            ...
                            <div class="col-md-offset-2 col-md-8">
                                <form action="#" method="#" role="search" class="form-horizontal">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="x" placeholder="Search event"
                                               id="search-data">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" type="button"><span
                                                        class="glyphicon glyphicon-search" style="padding: 4px"></span></button>
                                        </span>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="col-md-3 col-ms-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="blog-img">
                                        <img src="image/{{$event->image}}" class="img-responsive "
                                    ...
                                    <div class="blog-text" style="line-height:70%;padding-top:15px">
                                        ...
                                        <a href="event/page/{{$event->id}}"><h4
                                                    style="font-weight: bold">{{$event->title}}</h4></a>
                                ...
                                <div class="panel-footer ">
                                    <div class="row">
                                        <div class="col-md-offset-4 col-md-4 col-xs-offset-2 col-xs-4">
                                            <a href="" title="share"><i class="fa fa-share-square-o" aria-hidden="true"
                                                                        style="font-size:20px;color:green"></i>
                                                share</a>
                                        </div>
                                        <div class="col-md-4 col-xs-4">
                                            @if($save_events == null)
                                                <a href="saveEvent/{{$event->id}}" title="save"><i
                                                            class="fa fa-bookmark" hidden="true"
                                                            style="font-size:20px;color:blue"></i> save</a>
                                            @else
                                                {{$test = false}}
                                                @foreach($save_events as $save_event)
                                                    @if($event->id == $save_event->event_id)
                                                        <a href="unsaveEvent/{{$save_event->event_id}}"><i
                                                                    class="fa fa-check"
                                                                    aria-hidden="true" {{$test = true}}></i></a>
                                                    @endif
                                                @endforeach
                                                @if($test == false)
                                                    <a href="saveEvent/{{$event->id}}" title="save"><i
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="blog-text" style="line-height:70%;padding-top:15px">
                                                            <p style="color:green;">{{$event->time_start}}</p>
                                                            <a href="event/page/{{$event->id}}"><h4
                                                                        style="font-weight: bold">{{$event->title}}</h4>
                                                            </a>
                                                            <h5 style="font-weight: bold">{{$event->location}}</h5>
                                                        </div>
                                                    </div>
                                                    <div class="panel-footer ">
                                                        <div class="row">
                                                            <div class="col-md-offset-4 col-md-4 col-xs-offset-2 col-xs-4">
                                                                <a href="" title="share"><i class="fa fa-share-square-o"
                                                                                            aria-hidden="true"
                                                                                            style="font-size:20px;color:green"></i>
                                                                    share</a>
                                                            </div>
                                                            <div class="col-md-4 col-xs-4">
                                                                <a href="" title="save"> <i class="fa fa-bookmark"
                                                                                            aria-hidden="true"
